...
public class JsonSerializerTest {
	...
	@Test
	@Ignore("need a deserializer that goes onto values()[i].name")
	...
	@Test
	@Ignore("need a byte to string deserializer")
	public void roundtrip_iso8859_1_ok() throws Exception {
		String value = "äüöабв";
		Serializer serializer = JsonSerializer.builder().withCharset(StandardCharsets.ISO_8859_1).build();
